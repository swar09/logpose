...
//     schema::urls,
// };
// use diesel::{PgConnection, RunQueryDsl, SelectableHelper, query_dsl::methods::{FilterDsl, FindDsl}};
...
// // pub fn check_collision(short_code: String, conn: &mut PgConnection) {
// //     diesel::select(urls::table.filter(short_code))
// // }
